    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          // Once deleteActivity is successful, dispatch getAllActivity to refresh the list
                ...
                <div className="table-responsive">
                  ...
                  >
                    ...
                    <tbody>
                      {activities.length > 0 &&
                        activities
                          .filter((activity) => activity.type === "senate")
                          .map((activity) => {
                            return (
                              <tr key={activity._id}>
                                <td>
...
export default SenetorActivity;
